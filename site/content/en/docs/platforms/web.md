...
{{< cards >}}
  {{< card link="../ios" title="iOS" subtitle="Build native iOS apps with SwiftUI" >}}
  {{< card link="../android" title="Android" subtitle="Build native Android apps with Jetpack Compose" >}}
{{< /cards >}}
