...
{{< cards >}}
  {{< card link="virtual-dom" title="Virtual DOM" subtitle="Lightweight UI representation for efficient updates" >}}
  {{< card link="state-management" title="State Management" subtitle="Centralized, version-tracked application state" >}}
  {{< card link="components" title="Components" subtitle="Composable, reusable UI building blocks" >}}
  {{< card link="events" title="Event System" subtitle="Type-safe event handling and dispatch" >}}
{{< /cards >}}
...
┌─────────────────────────────────────────────────────────────────────┐
│                      Platform Shell                                  │
│              (Swift, Kotlin, JavaScript, C#, C)                      │
│                                                                      │
│  Converts native events to Zylix events                              │
│  Calls: zylix_dispatch(event_type, payload)                         │
└──────────────────────────────┬──────────────────────────────────────┘
                               │
                               ▼
┌─────────────────────────────────────────────────────────────────────┐
...
│                      Virtual DOM Builder                             │
│                                                                      │
│  Constructs new VNode tree from state                                │
│  Uses component render functions                                     │
└──────────────────────────────┬──────────────────────────────────────┘
                               │
                               ▼
┌─────────────────────────────────────────────────────────────────────┐
...
│                      Platform Shell                                  │
│                                                                      │
│  Receives patches via zylix_get_patches()                           │
│  Applies patches to native UI elements                               │
└──────────────────────────────┬──────────────────────────────────────┘
                               │
                               ▼
┌─────────────────────────────────────────────────────────────────────┐
