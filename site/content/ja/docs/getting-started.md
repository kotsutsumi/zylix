...
{{< cards >}}
  {{< card link="../architecture" title="アーキテクチャ" subtitle="Zylix の内部構造を学ぶ" >}}
  {{< card link="../core-concepts" title="コア概念" subtitle="Virtual DOM、状態管理など" >}}
  {{< card link="../platforms" title="プラットフォームガイド" subtitle="各プラットフォームの詳細" >}}
{{< /cards >}}
