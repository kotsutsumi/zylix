...
{{< callout type="info" >}}
**ステータス: ✅ 本番環境対応** — このプラットフォームはZigコアとの完全な統合が完了しており、動作するデモとテスト済みの機能があります。
{{< /callout >}}
...
{{< cards >}}
  {{< card link="../ios" title="iOS" subtitle="SwiftUI でネイティブ iOS アプリを構築" >}}
  {{< card link="../android" title="Android" subtitle="Jetpack Compose でネイティブ Android アプリを構築" >}}
{{< /cards >}}
